...
export function extractModelName(model: unknown): string | undefined {
...
export function stripForcedAuthType(payload: Record<string, any>): void {
...
export function ensureCodexPayloadCompatibility(payload: Record<string, any>): Record<string, any> {
